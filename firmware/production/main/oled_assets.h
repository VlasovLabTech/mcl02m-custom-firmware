...
extern const uint8_t oled_image_ready_1[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_ready_2[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_ready_3[OLED_ASSET_FRAME_BYTES];
...
extern const uint8_t oled_image_wifi_present[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_hot[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_delayed_start[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_small_cookware[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_noopls[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_too_hot[OLED_ASSET_FRAME_BYTES];
extern const uint8_t oled_image_what_is_going_on[OLED_ASSET_FRAME_BYTES];
