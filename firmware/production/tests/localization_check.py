...
def main() -> int:
    ...
    manual_required = {
        "en": ("40…190", "210", "P<36", "Small cookware", "Hot surface",
               ...
               "0.2.38-dev", "SCREEN ON", "COOK MODE", "DEBUG SHOW R21",
               "SHOW DEBUG BAD I2C CNT", "B000…B999"),
        "ru": ("40…190", "210", "P<36", "Маленькая посуда",
               ...
               "4 кГц", "по 300 мс", "паузами 100 мс", "0.2.38-dev", "ЭКРАН ПРИ / ГОТОВКЕ ВКЛ",
               "DEBUG SHOW R21", "SHOW DEBUG BAD I2C CNT", "B000…B999"),
        "zh": ("40…190", "210", "P<36", "小锅具", "热表面",
               ...
               "不会自动恢复", "4 kHz", "300毫秒", "间隔100毫秒", "0.2.38-dev", "屏幕常开 / 启动后",
               "DEBUG SHOW R21", "SHOW DEBUG BAD I2C CNT", "B000…B999"),
    }
